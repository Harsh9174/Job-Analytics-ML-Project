...
# Fill missing skill columns with empty strings and create lowercase versions for searching
...
st.markdown("<h4> Our search feature displays the most prevalent experience level, top workplace, and popular classes for a particular skill, along with the total number of jobs related to that skill.</h4>", unsafe_allow_html=True)
...
if text_search:
    ...
    # Create masks for skills in different columns
    ...
    # Combine masks to get the search results
...
if st.button("Job Details >>"):
    ...
    # Card style for displaying job details
    card_style = """
    <style>
    .card {
    ...
    # Loop through records and create job cards
